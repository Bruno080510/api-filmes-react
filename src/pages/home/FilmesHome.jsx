...
function FilmesHome() {
    ...
    return (
        <div className=" pb-20">
            <h1 className=" text-3xl ps-7 font-semibold py-8 ">10s today</h1>
            <div className=" relative flex items-center" >
                ...
                |<div id="slider" className="scrollbar-hide w-full h-full overflow-x-scroll  overflow-y-hidden scroll whitespace-nowrap scroll-smooth">     
                    {movies && movies.length > 0 && movies.map((movie) => {
                        return (
                            <Link to={`/${movie.id}`}>
                            <div className=" pb-8 pt-5 ps-7 w-[300px] h-[450px] pe-8 cursor-pointer hover:scale-105 ease-in-out duration-300  inline-block" key={movie.id}>
